...
```{r Figure1, eval=TRUE, echo=FALSE, fig.cap="Flow chart of the priorCON prioritization analysis. priorCON functions are indicated in grey boxes", out.width = '100%', fig.align = "center"}
...
<!-- All the functions of the package **priorCON** at the development version can be installed in R via -->
